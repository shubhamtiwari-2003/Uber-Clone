  ...
  return (
    <div>
      <div className="h-screen">
        <Link to={"/home"} className="fixed h-10 w-10 bg-white flex items-center justify-center rounded-full top-5 right-5 z-10">
        <i className=" font-medium  text-lg ri-home-9-line"></i>
        </Link>
        <img
        ...
        <div className=" h-1/2 flex flex-col items-center ">
          <div className="flex item-center gap-10">
            ...
            <div className="pr-3 pt-4 text-right">
              ...
              <h4 className="text-sm font-bold">MP04 AB 1234</h4>
          ...
          {/* ........................ */}
          <button className="bg-green-600 w-[94%] h-10 m-3 text-white px-3 py-2 rounded-md font-bold ">
            Make a Payment
          </button>
        </div>
      </div>
